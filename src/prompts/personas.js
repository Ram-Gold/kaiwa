 ...
 * Every persona system prompt enforces a JSON output contract:
 * `SUGGESTIONS: [{"text": "...", "isCorrect": true/false, "explanation": "..."}]`
 * This payload is parsed by `extractSuggestions()` in `src/lib/ai.js` to render the 5 card choices.
 * ============================================================================
 */
...
Your job:
- Prompt the learner to use basic Japanese action verbs (食べます, 行きます, 見ます, 飲みます, etc.).
...
Your job:
- Practice essential greetings, thank yous, apologies, and quick polite reactions (ありがとうございます, すみません, 大丈夫です, お願いします).
...
- Keep all interactions completely safe, wholesome, and professional.
